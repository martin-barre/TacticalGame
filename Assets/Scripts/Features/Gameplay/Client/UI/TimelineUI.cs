...
public class TimelineUI : ClientStateBoundBehaviour
{
    ...
    private void OnEntitiesChanged()
    {
        ...
        // Recreate
        foreach (Entity entity in ClientState.GameState.Entities)
        {
            TimelineEntityUI instance = _prefabFactory.Instantiate(timelineEntityUI, transform);
